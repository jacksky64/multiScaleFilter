...
namespace cp
{
	...
	class  MultiScaleGaussianFilter : public MultiScaleFilter
	{
	public:
	...
	class  MultiScaleBilateralFilter : public MultiScaleFilter
	{
	public:
		void filter(const cv::Mat& src, cv::Mat& dest, const float sigma_range, const float sigma_space, const float boost = 1.f, const int level = 2, const ScaleSpace scaleSpaceMethod = ScaleSpace::Pyramid);
	...
	class  LocalMultiScaleFilterFull : public MultiScaleFilter
	{
	public:
		void filter(const cv::Mat& src, cv::Mat& dest, const float sigma_range, const float sigma_space, const float boost = 1.f, const int level = 2, const ScaleSpace scaleSpaceMethod = ScaleSpace::Pyramid);
	protected:
	...
	class  LocalMultiScaleFilter : public MultiScaleFilter
	{
	public:
		void filter(const cv::Mat& src, cv::Mat& dest, const float sigma_range, const float sigma_space, const float boost = 1.f, const int level = 2, const ScaleSpace scaleSpaceMethod = ScaleSpace::Pyramid);
	protected:
	...
	class  FastLLFReference : public MultiScaleFilter
	{
	public:
	...
	class  LocalMultiScaleFilterInterpolation : public MultiScaleFilter
	{
	public:
		//interpolationMethod: {cv::INTER_NEAREST, cv::INTER_LINEAR, cv::INTER_CUBIC}
		void filter(const cv::Mat& src, cv::Mat& dest, const int order, const float sigma_range, const float sigma_space, const float boost = 1.f, const int level = 2, const ScaleSpace scaleSpaceMethod = ScaleSpace::Pyramid, const int interpolationMethod = cv::INTER_LINEAR);
	...
	//reference implementation: not optimized
	class  LocalMultiScaleFilterFourierReference : public MultiScaleFilter
	{
	public:
	...
	class  LocalMultiScaleFilterFourier : public MultiScaleFilter
	{
	public:
...
#pragma endregion
	...
	class  TileLocalMultiScaleFilterInterpolation :public cp::TileParallelBody
	{
	...
	class  TileLocalMultiScaleFilterFourier :public cp::TileParallelBody
	{
	...
	//alias: LocalMultiScaleFilterFull
	 void localLaplacianFilterFull(cv::InputArray src, cv::OutputArray dest, const float sigma_range, const float sigma_space, const float boost, const int level);
	//alias: LocalMultiScaleFilter with pyramid
	 void localLaplacianFilter(cv::InputArray src, cv::OutputArray dest, const float sigma_range, const float sigma_space, const float boost, const int level);
	//alias: LocalMultiScaleFilter with DoG
	 void localDoGFilter(cv::InputArray src, cv::OutputArray dest, const float sigma_range, const float sigma_space, const float boost, const int level);
	//alias: LocalMultiScaleFilterInterpolation with pyramid
	 void fastLocalLaplacianFilter(cv::InputArray src, cv::OutputArray dest, const int order, const float sigma_range, const float sigma_space, const float boost, const int level);
	//alias: LocalMultiScaleFilterInterpolation with DoG
	 void fastLocalDoGFilter(cv::InputArray src, cv::OutputArray dest, const int order, const float sigma_range, const float sigma_space, const float boost, const int level);
	//alias: LocalMultiScaleFilterFourier with pyramid
	 void FourierLocalLaplacianFilter(cv::InputArray src, cv::OutputArray dest, const int order, const float sigma_range, const float sigma_space, const float boost, const int level);
	//alias: LocalMultiScaleFilterFourier with DoG
	 void FourierLocalDoGFilter(cv::InputArray src, cv::OutputArray dest, const int order, const float sigma_range, const float sigma_space, const float boost, const int level);
}